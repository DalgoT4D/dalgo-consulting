# /write_intermediate — Write And Verify Intermediate Models
...
- the working tree has unexpected changes in files this command would edit.
...
Then print:
> "Next → run `/write_mart` after reviewing intermediate outputs."
